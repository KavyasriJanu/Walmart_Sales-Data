# Walmart_Sales-Data# Analysis: End-to-End SQL + Python Project
...
### 2. Set Up Kaggle API
   - **API Setup**: Obtained Kaggle API token from [Kaggle](https://www.kaggle.com/) by navigating to the profile settings and downloading the JSON file.
   - **Configure Kaggle**: 
...
2. Install Python libraries:
   ...
   ```
3. Set up Kaggle API, download the data, and follow the steps to load and analyze.
